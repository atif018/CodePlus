...
public class PythonProgramQuiz31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz31);
    ...
    public void pythonSixSR4() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonSixSR4.class);
            editor.putString("pythonSaveSix", "PythonSixSR4");
            editor.apply();
        } else {
            intent = new Intent(this, PythonSixPointFour.class);
            editor.putString("pythonSaveSix", "PythonSixPointFive");
            editor.apply();
        }
