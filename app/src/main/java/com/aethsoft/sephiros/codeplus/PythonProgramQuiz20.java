...
public class PythonProgramQuiz20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz20);
    ...
    public void pythonFourSR3() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonFourSR3.class);
            editor.putString("pythonSaveFour", "PythonFourSR3");
            editor.apply();
        } else {
