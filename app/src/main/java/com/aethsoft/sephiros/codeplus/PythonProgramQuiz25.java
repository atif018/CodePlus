...
public class PythonProgramQuiz25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz25);
    ...
    public void pythonProgramQuiz26() {

        SharedPreferences sharedPref = getApplicationContext().getSharedPreferences("CodePlusSaves", 0);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putString("pythonSaveFive", "PythonProgramQuiz26");
        editor.apply();

        Intent intent = new Intent(this, PythonProgramQuiz26.class);
