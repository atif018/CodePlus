...
public class JavaProgramQuiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_program_quiz2);
    ...
    public void javaProgramQuiz3() {

        SharedPreferences sharedPref = getApplicationContext().getSharedPreferences("CodePlusSaves", 0);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putString("javaSaveOne", "JavaProgramQuiz3");
        editor.commit();

        Intent intent = new Intent(this, JavaProgramQuiz3.class);
