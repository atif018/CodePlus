...
public class PythonProgramQuiz32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz32);
    ...
    public void pythonSixSR5() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            editor.putString("pythonSaveSix", "PythonSixSR5");
            editor.apply();
        } else {
            intent = new Intent(this, StartPython7.class);
