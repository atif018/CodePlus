...
public class PythonProgramQuiz9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz9);
    ...
    public void pythonProgramQuiz10() {

        SharedPreferences sharedPref = getApplicationContext().getSharedPreferences("CodePlusSaves", 0);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putString("pythonSaveTwo", "PythonProgramQuiz10");
        editor.apply();

        Intent intent = new Intent(this, PythonProgramQuiz10.class);
