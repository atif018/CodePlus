...
public class PythonProgramQuiz5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz5);
    ...
    public void pythonProgramQuiz6() {

        SharedPreferences sharedPref = getApplicationContext().getSharedPreferences("CodePlusSaves", 0);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putString("pythonSaveOne", "PythonProgramQuiz6");
        editor.apply();

        Intent intent = new Intent(this, PythonProgramQuiz6.class);
