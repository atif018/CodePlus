...
public class PythonProgramQuiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz4);
    ...
    public void pythonOneSR3() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonOneSR3.class);
            editor.putString("pythonSaveOne", "PythonOneSR3");
            editor.apply();
        } else {
