...
public class PythonProgramQuiz10 extends AppCompatActivity {

    private String answer = "i";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_python_program_quiz10);
    ...
    public void pythonProgramQuiz11() {

        SharedPreferences sharedPref = getApplicationContext().getSharedPreferences("CodePlusSaves", 0);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putString("pythonSaveTwo", "PythonProgramQuiz11");
        editor.apply();

        Intent intent = new Intent(this, PythonProgramQuiz11.class);
