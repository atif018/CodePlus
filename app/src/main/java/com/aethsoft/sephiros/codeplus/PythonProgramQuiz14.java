...
public class PythonProgramQuiz14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz14);
    ...
    public void pythonThreeSR2() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonThreeSR2.class);
            editor.putString("pythonSaveThree", "PythonThreeSR2");
            editor.apply();
        } else {
