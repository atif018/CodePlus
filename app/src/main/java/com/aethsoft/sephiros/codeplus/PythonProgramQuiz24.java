...
public class PythonProgramQuiz24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz24);
    ...
    public void pythonFiveSR3() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonFiveSR3.class);
            editor.putString("pythonSaveFive", "PythonFiveSR3");
            editor.apply();
        } else {
            intent = new Intent(this, PythonFivePointFour.class);
            editor.putString("pythonSaveFive", "PythonFivePointFour");
            editor.apply();
        }
