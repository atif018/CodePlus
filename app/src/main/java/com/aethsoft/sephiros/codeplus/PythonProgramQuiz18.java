...
public class PythonProgramQuiz18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz18);
    ...
    public void pythonFourSR1() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonFourSR1.class);
            editor.putString("pythonSaveFour", "PythonFourSR1");
            editor.apply();
        } else {
