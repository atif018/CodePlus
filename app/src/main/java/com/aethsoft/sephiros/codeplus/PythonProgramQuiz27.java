...
public class PythonProgramQuiz27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz27);
    ...
    public void pythonFiveSR4() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonFiveSR4.class);
            editor.putString("pythonSaveFive", "PythonFiveSR4");
            editor.apply();
        } else {
            intent = new Intent(this, StartPython6.class);
            editor.putString("pythonSaveFive", null);
            editor.apply();
        }
