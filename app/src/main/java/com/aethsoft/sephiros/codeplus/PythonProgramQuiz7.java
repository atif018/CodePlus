...
public class PythonProgramQuiz7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz7);
    ...
    public void pythonTwoSR1() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonTwoSR1.class);
            editor.putString("pythonSaveTwo", "PythonTwoSR1");
            editor.apply();
        } else {
