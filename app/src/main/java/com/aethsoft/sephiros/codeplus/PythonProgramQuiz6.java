...
public class PythonProgramQuiz6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz6);
    ...
    public void pythonOneSR4() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonOneSR4.class);
            editor.putString("pythonSaveOne", "PythonOneSR4");
            editor.apply();
        } else {
            intent = new Intent(this, StartPython2.class);
