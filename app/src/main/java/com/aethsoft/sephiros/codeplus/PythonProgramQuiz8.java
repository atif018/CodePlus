...
public class PythonProgramQuiz8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz8);
    ...
    public void pythonTwoSR2() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonTwoSR2.class);
            editor.putString("pythonSaveTwo", "PythonTwoSR2");
            editor.apply();
        } else {
