...
public class PythonProgramQuiz30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz30);
    ...
    public void pythonSixSR3() {
        ...
        if (getSRTopicNumber == 1) {
            ...
            intent = new Intent(this, PythonSixSR3.class);
            editor.putString("pythonSaveSix", "PythonSixSR3");
            editor.apply();
        } else {
