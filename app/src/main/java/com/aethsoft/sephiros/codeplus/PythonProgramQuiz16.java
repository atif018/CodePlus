...
public class PythonProgramQuiz16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_program_quiz16);
    ...
    public void pythonProgramQuiz17() {

        SharedPreferences sharedPref = getApplicationContext().getSharedPreferences("CodePlusSaves", 0);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putString("pythonSaveThree", "PythonProgramQuiz17");
        editor.apply();

        Intent intent = new Intent(this, PythonProgramQuiz17.class);
